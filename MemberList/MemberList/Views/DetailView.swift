...
class DetailView: UIView {
    ...
    var member: Member? {
        didSet {
            ...
            addressNumberTextField.text = member.address
    ...
    private let addressNumberLabel: UILabel = {
        let label = UILabel()
        label.font = UIFont.boldSystemFont(ofSize: 16)
        label.text = "주       소:"
        label.translatesAutoresizingMaskIntoConstraints = false
    ...
    let addressNumberTextField: UITextField = {
        let tf = UITextField()
        tf.frame.size.height = 22
        tf.borderStyle = .roundedRect
        tf.autocapitalizationType = .none
    ...
    private lazy var addressStackView: UIStackView = {
        let stview = UIStackView(arrangedSubviews: [addressNumberLabel, addressNumberTextField])
        stview.spacing = 5
        stview.axis = .horizontal
        stview.distribution = .fill
        stview.alignment = .fill
    ...
    private lazy var stackView: UIStackView = {
        let stview = UIStackView(arrangedSubviews: [imageContainView, memberIdStackView, nameStackView, ageStackView, phoneStackView, addressStackView, saveButton])
        stview.spacing = 10
    ...
    private func setupMemberIdTextField() {
    ...
    private func setConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            addressNumberLabel.widthAnchor.constraint(equalToConstant: labelWidth)
        ])
    ...
    //MARK: - 키보드가 나타날 때와 내려갈 때의 애니메이션 세팅
