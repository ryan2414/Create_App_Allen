...
class ViewController: UIViewController, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return moviesArrar.count //컨텐츠 생성 개수
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //let movie = moviesArrar[indexPath.row]
        cell.mainImageView.image = moviesArrar[indexPath.row].movieImage
        cell.movieNameLabel.text = moviesArrar[indexPath.row].movieName
        cell.movieDescription.text = moviesArrar[indexPath.row].movieDescription
